 ...
 */
package com.koles.level_19.lecture_6.task_2_product_overdue;
...
public class Solution {
    ...
    private boolean hasExpiredProduct(Stream<Product> productStream){
        LocalDate now = LocalDate.now();
        
        return productStream.anyMatch(product -> (product.getExpirationDate()
                .isBefore(now)));
    }
}
